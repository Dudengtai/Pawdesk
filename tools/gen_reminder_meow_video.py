"""Generate reminder meow (wide-open mouth) video from master keyframe."""
...
MASTER = ROOT / "assets" / "pets" / "cow-cat" / "_master" / "base_reminder_meow_magenta.jpg"
OUT_NAME = "reminder_meow"

PROMPT = (
    "Same cartoon black-and-white tuxedo cat stays seated full body on solid magenta. "
    "It meows insistently with the huge open mouth: jaw pulses more open and less open, "
    "head bobbles gently up and down, tiny body sway, eyes stay wide yellow. "
    "Locked camera, no zoom, solid magenta background always, keep exact identity."
)
