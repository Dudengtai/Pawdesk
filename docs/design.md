...
| 项目 | 内容 |
| --- | --- |
| 版本 | **v0.21**（2026-08-17：取消托盘暂停/打开设置；设置暂停开玩笑；改大小预览） |
| 依据 | `prd.md` v0.7.8 · `tech.md` v0.18 |
...
- 关闭设置 ≠ 退出应用。  
- 调大小时：设置内 `−`/`+` 即时预览宠；「完成」后启动坞与回待机都保持新尺寸，窗不抖（`idle_present_pos` 原子 present）。托盘变大/变小在待机即时改窗。
