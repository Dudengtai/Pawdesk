...
| 项目 | 内容 |
| --- | --- |
| 版本 | **v0.20**（2026-08-17：坞卡无外阴影 + 宠自由剪影 + 拖动分层合成） |
| 依据 | `prd.md` v0.7.7 · `tech.md` v0.17 |
...
- 打开方式：从启动坞右上角肉垫印点击时，**窗与猫钉死**，设置在原坞卡内从右侧滑入（220ms ease-in-out）；「完成」反转滑回启动坞。托盘「打开设置」保持居中直开。
- 与启动坞同一套玻璃 / 圆角 / 字号气质。  
- 分区顺序：  
  1. **健康提醒**（开关、间隔、暂停）  
  2. **宠物大小**（`−` / 百分比 / `+`，相对设计基准）  
