...
| 文档类型 | 开发任务与模块排期 |
| 当前版本 | **v0.11**（2026-08-12：设置从「管理」按钮丝滑生长并停靠启动坞旁） |
| 依据文档 | `prd.md` v0.5、`tech.md` v0.8、`design.md` v0.10 |
| 环境参考 | `env.md` |
| 状态 | **M0–M5 可日常使用**；**M6 坞精致化主路径已落地**；**cow-cat 精灵桌面可读性收口**；**PET-A07 阶段 B（cute）已开**；**设置转场已落地**；字体更精致化后期 |
